    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row space-x-4 mt-5">
                            ...
                            <button className="seam-button-alt px-4 py-2 rounded-full bg-gradient-to-b from-[#a5ecff] via-[#67defd] to-[#54daff] font-medium">Vaults</button>
                            </a>
                            <a href="https://docs.seam.money">
                            <button className="seam-button flex flex-shrink-0 items-center px-6 py-2 rounded-full space-x-2 text-sm">
                                <span>Docs</span>
